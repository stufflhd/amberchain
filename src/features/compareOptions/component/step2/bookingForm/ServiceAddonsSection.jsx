      ...
      <Section title="Service Add-Ons">
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Customs Brokerage */}
            {["sea", "rail", "road", "air", "ecommerce"].includes(data.mode) && (
              <div className="flex flex-col gap-2 rounded-xl border border-border/40 bg-background/50 p-3 hover:shadow-md transition-all">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-4">
            {[
              ...
              .map((item) => (
                <div
                  key={item.key}
                  className="flex items-center justify-between px-3 py-2 rounded-md border border-border/30 bg-muted/30 hover:bg-muted/50 transition cursor-pointer"
                >
