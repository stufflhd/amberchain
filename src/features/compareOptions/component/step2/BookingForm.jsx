        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 p-2 border border-border rounded-lg bg-card/50">
            ...
            <div className="grid grid-cols-2 gap-3 items-center">
              ...
              <Label className="col-span-1 flex items-center gap-2 text-sm"># Packages</Label>
              <Input 
                type="number"
              ...
              <div className="col-span-2 flex items-center gap-3">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="cold-yes" className="text-sm font-medium">Yes</label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="no" id="cold-no" />
                    <label htmlFor="cold-no" className="text-sm font-medium">No</label>
                  </div>
                </RadioGroup>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <label htmlFor="drain-open" className="text-sm font-medium">Open</label>
                      </div>
                      <div className="flex items-center gap-2">
                        <RadioGroupItem value="closed" id="drain-closed" />
                        <label htmlFor="drain-closed" className="text-sm font-medium">Closed</label>
                      </div>
                    </RadioGroup>
                  </div>
                </div>
                ...
                >
                  <div className="flex gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <label htmlFor="export-yes" className="text-sm font-medium">Yes</label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="no" id="export-no" />
                      <label htmlFor="export-no" className="text-sm font-medium">No</label>
                    </div>
                  </div>
                </RadioGroup>
              </div>
                ...
                >
                  <div className="flex gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <label htmlFor="import-yes" className="text-sm font-medium">Yes</label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="no" id="import-no" />
                      <label htmlFor="import-no" className="text-sm font-medium">No</label>
                    </div>
                  </div>
                </RadioGroup>
              </div>
